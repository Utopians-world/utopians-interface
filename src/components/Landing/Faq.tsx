...
const QAs: {
  ...
  },
  {
    ...
    a: [
      ...
      `5% of all money made by projects is sent to help pay for the maintenance and development of Juicebox itself. In exchange, projects get Juicebox tokens ($UTO), which will be worth more as the ecosystem grows over time.`,
    ],
  },
  {
    q: `What is overflow?`,
